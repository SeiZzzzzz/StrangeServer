namespace StrangeServerCSharp
{
    public class Inventory
    {
        ...
        public bool Diz(uint x, uint y, out Building rpack)
        {
            ...
            var xp = (uint)(x + (player.dir == 3 ? 3 : player.dir == 1 ? -3 : 0));
            var yp = (uint)(y + (player.dir == 0 ? 3 : player.dir == 2 ? -3 : 0));
            var xx = xp;
            var yy = yp;
            if (player.dir == 3 || player.dir == 1)
            {
                if (xp < x)
                {
                    for (; xx <= x; xx++)
                    {
                        ...
                        {
                            if (World.packmap[xx + y * World.width] != null &&
                                World.packmap[xx + y * World.width].ownerid == player.id)
                            {
            ...
            else if (player.dir == 0 || player.dir == 2)
            {
                if (yp < y)
                {
                    for (; yy <= y; yy++)
                    {
                        ...
                        {
                            if (World.packmap[x + yy * World.width] != null &&
                                World.packmap[x + yy * World.width].ownerid == player.id)
                            {
